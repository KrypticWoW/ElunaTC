...
int const customPyramidSpawnTotal = 54;
/* list of wave spawns: 0 = wave ID, 1 = creature id, 2 = x, 3 = y
no z coordinat b/c they're all the same */
float customPyramidSpawns [customPyramidSpawnTotal][4] = {
    {1, 60076, 1894.64f, 1206.29f},
    {1, 60074, 1890.08f, 1218.68f},
    {1, 60078, 1883.76f, 1222.3f},
    {1, 60076, 1874.18f, 1221.24f},
    {1, 60074, 1892.28f, 1225.49f},
    {1, 60075, 1889.94f, 1212.21f},
    {1, 60074, 1879.02f, 1223.06f},
    {1, 60076, 1874.45f, 1204.44f},
    {1, 60078, 1898.23f, 1217.97f},
    {1, 60074, 1882.07f, 1225.7f},
    {1, 60079, 1896.46f, 1205.62f},
    {1, 60074, 1886.97f, 1225.86f},
    {1, 60074, 1894.72f, 1221.91f},
    {1, 60074, 1883.5f, 1218.25f},
    {1, 60074, 1886.93f, 1221.4f},
    {1, 60078, 1889.82f, 1222.51f},
    {1, 60075, 1893.07f, 1215.26f},
    {1, 60075, 1878.57f, 1214.16f},
    {1, 60075, 1883.74f, 1212.35f},
    {1, 60079, 1877, 1207.27f},
    {1, 60079, 1873.63f, 1204.65f},
    {1, 60078, 1877.4f, 1216.41f},
    {1, 60079, 1899.63f, 1202.52f},
    {2, 60076, 1902.83f, 1223.41f},
    {2, 60078, 1889.82f, 1222.51f},
    {2, 60074, 1883.5f, 1218.25f},
    {2, 60075, 1883.74f, 1212.35f},
    {2, 60079, 1877, 1207.27f},
    {2, 60074, 1890.08f, 1218.68f},
    {2, 60076, 1894.64f, 1206.29f},
    {2, 60078, 1877.4f, 1216.41f},
    {2, 60074, 1892.28f, 1225.49f},
    {2, 60075, 1893.07f, 1215.26f},
    {2, 60079, 1896.46f, 1205.62f},
    {2, 60076, 1874.45f, 1204.44f},
    {2, 60076, 1874.18f, 1221.24f},
    {2, 60074, 1879.02f, 1223.06f},
    {2, 60078, 1898.23f, 1217.97f},
    {2, 60074, 1882.07f, 1225.7f},
    {2, 60079, 1873.63f, 1204.65f},
    {2, 60074, 1886.97f, 1225.86f},
    {2, 60075, 1878.57f, 1214.16f},
    {2, 60074, 1894.72f, 1221.91f},
    {2, 60074, 1886.93f, 1221.4f},
    {2, 60078, 1883.76f, 1222.3f},
    {2, 60075, 1889.94f, 1212.21f},
    {2, 60079, 1899.63f, 1202.52f},
    {3, 60075, 1878.57f, 1214.16f},
    {3, 60074, 1894.72f, 1221.91f},
    {3, 60074, 1886.93f, 1221.4f},
    {3, 60078, 1883.76f, 1222.3f},
    {3, 60075, 1889.94f, 1212.21f},
    {3, 60073, 1889.23f, 1207.72f},
    {3, 60077, 1879.77f, 1207.96f}
};

float CustomSpawnsway[2][3] =
{
    {1884.86f, 1228.62f, 9},
    {1887.53f, 1263, 41}
};

class custom_instance_zulfarrak : public InstanceMapScript
{
public:
    custom_instance_zulfarrak() : InstanceMapScript(CustomZFScriptName, 727) { }
    ...
    struct instance_zulfarrak_InstanceMapScript : public InstanceScript
    {
        ...
        {
            for (int i = 0; i < customPyramidSpawnTotal; i++)
            {
                if (customPyramidSpawns[i][0] == (float)wave)
                {
                    Position pos = { customPyramidSpawns[i][2], customPyramidSpawns[i][3], 8.87f, 0};
                    TempSummon* ts = instance->SummonCreature(uint32(customPyramidSpawns[i][1]), pos);
