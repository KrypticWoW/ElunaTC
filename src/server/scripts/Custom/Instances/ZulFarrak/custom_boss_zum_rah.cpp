...
class custom_boss_zum_rah : public CreatureScript
{
public:
    custom_boss_zum_rah() : CreatureScript("custom_boss_zum_rah") { }

    struct custom_boss_zum_rahAI : public BossAI
    {
        custom_boss_zum_rahAI(Creature* creature) : BossAI(creature, DATA_ZUM_RAH)
        {
            Initialize();
        }
    ...
    {
        return GetCustomZulFarrakAI<custom_boss_zum_rahAI>(creature);
    }
};

void AddSC_custom_boss_zum_rah()
{
    new custom_boss_zum_rah();
}
