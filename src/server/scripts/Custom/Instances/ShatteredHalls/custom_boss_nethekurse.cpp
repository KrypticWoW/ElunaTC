...
class custom_boss_grand_warlock_nethekurse : public CreatureScript
{
    public:
        custom_boss_grand_warlock_nethekurse() : CreatureScript("custom_boss_grand_warlock_nethekurse") { }

        struct custom_boss_grand_warlock_nethekurseAI : public BossAI
        {
            custom_boss_grand_warlock_nethekurseAI(Creature* creature) : BossAI(creature, DATA_NETHEKURSE)
            {
                Initialize();
            }
        ...
        {
            return GetCustomShatteredHallsAI<custom_boss_grand_warlock_nethekurseAI>(creature);
        }
};
...
class custom_npc_fel_orc_convert : public CreatureScript
{
    public:
        custom_npc_fel_orc_convert() : CreatureScript("custom_npc_fel_orc_convert") { }

        struct custom_npc_fel_orc_convertAI : public ScriptedAI
        {
            custom_npc_fel_orc_convertAI(Creature* creature) : ScriptedAI(creature)
            {
        ...
        CreatureAI* GetAI(Creature* creature) const override
        {
            return GetCustomShatteredHallsAI<custom_npc_fel_orc_convertAI>(creature);
        }
};
...
class custom_npc_lesser_shadow_fissure : public CreatureScript
{
    public:
        custom_npc_lesser_shadow_fissure() : CreatureScript("custom_npc_lesser_shadow_fissure") { }

        struct custom_npc_lesser_shadow_fissureAI : public ScriptedAI
        {
        ...
        CreatureAI* GetAI(Creature* creature) const override
        {
            return GetCustomShatteredHallsAI<custom_npc_lesser_shadow_fissureAI>(creature);
        }
};

void AddSC_custom_boss_grand_warlock_nethekurse()
{
    new custom_boss_grand_warlock_nethekurse();
    new custom_npc_fel_orc_convert();
    new custom_npc_lesser_shadow_fissure();
}
