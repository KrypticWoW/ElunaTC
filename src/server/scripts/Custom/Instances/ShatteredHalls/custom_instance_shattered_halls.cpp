...
class custom_instance_shattered_halls : public InstanceMapScript
{
    public:
        custom_instance_shattered_halls() : InstanceMapScript(CustomSHScriptName, 728) { }

        InstanceScript* GetInstanceScript(InstanceMap* map) const override
        {
            return new custom_instance_shattered_halls_InstanceMapScript(map);
        }

        struct custom_instance_shattered_halls_InstanceMapScript : public InstanceScript
        {
            custom_instance_shattered_halls_InstanceMapScript(InstanceMap* map) : InstanceScript(map)
            {
            ...
            void ReadSaveDataMore(std::istringstream& data) override
            {
                ...
                instance->LoadGrid(CustomExecutioner.GetPositionX(), CustomExecutioner.GetPositionY());
...
{
    new custom_instance_shattered_halls();
}
