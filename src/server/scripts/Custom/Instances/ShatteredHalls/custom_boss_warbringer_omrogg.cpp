...
class custom_boss_warbringer_omrogg : public CreatureScript
{
    public:
        custom_boss_warbringer_omrogg() : CreatureScript("custom_boss_warbringer_omrogg") { }

        struct custom_boss_warbringer_omroggAI : public BossAI
        {
            custom_boss_warbringer_omroggAI(Creature* creature) : BossAI(creature, DATA_OMROGG)
            {
                Initialize();
                iaggro = 0;
                ithreat = 0;
        ...
        {
            return GetCustomShatteredHallsAI<custom_boss_warbringer_omroggAI>(creature);
        }
};
...
class custom_npc_omrogg_heads : public CreatureScript
{
    public:
        custom_npc_omrogg_heads() : CreatureScript("custom_npc_omrogg_heads") { }

        struct custom_npc_omrogg_headsAI : public ScriptedAI
        {
            custom_npc_omrogg_headsAI(Creature* creature) : ScriptedAI(creature)
            {
        ...
        CreatureAI* GetAI(Creature* creature) const override
        {
            return GetCustomShatteredHallsAI<custom_npc_omrogg_headsAI>(creature);
        }
};

void AddSC_custom_boss_warbringer_omrogg()
{
    new custom_boss_warbringer_omrogg();
    new custom_npc_omrogg_heads();
}
