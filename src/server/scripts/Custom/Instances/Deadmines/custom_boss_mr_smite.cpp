...
class custom_boss_mr_smite : public CreatureScript
{
public:
    custom_boss_mr_smite() : CreatureScript("custom_boss_mr_smite") { }

    CreatureAI* GetAI(Creature* creature) const override
    {
        return GetCustomDeadminesAI<custom_boss_mr_smiteAI>(creature);
    }

    struct custom_boss_mr_smiteAI : public ScriptedAI
    {
        custom_boss_mr_smiteAI(Creature* creature) : ScriptedAI(creature)
        {
            Initialize();
