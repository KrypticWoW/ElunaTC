...
class custom_instance_ahnkahet : public InstanceMapScript
{
    public:
        custom_instance_ahnkahet() : InstanceMapScript(CustomAhnKahetScriptName, 729) { }

        struct custom_instance_ahnkahet_InstanceScript : public InstanceScript
        {
            custom_instance_ahnkahet_InstanceScript(InstanceMap* map) : InstanceScript(map)
            {
        ...
        {
           return new custom_instance_ahnkahet_InstanceScript(map);
        }
};

void AddSC_custom_instance_ahnkahet()
{
    new custom_instance_ahnkahet();
}
