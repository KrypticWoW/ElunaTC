...
enum PrinceTaldaramSpells
{
    ...
    SPELL_CONJURE_FLAME_SPHERE              = 102020,
    SPELL_FLAME_SPHERE_SUMMON_1             = 102021, // 1x 60266
    SPELL_FLAME_SPHERE_SUMMON_2             = 102022, // 1x 60267
    SPELL_FLAME_SPHERE_SUMMON_3             = 102023, // 1x 60268
    SPELL_FLAME_SPHERE_SPAWN_EFFECT         = 102024,
    ...
    NPC_FLAME_SPHERE_1                      = 60266,
    NPC_FLAME_SPHERE_2                      = 60267,
    NPC_FLAME_SPHERE_3                      = 60268,

    SPELL_BEAM_VISUAL                       = 102036,
...
struct custom_boss_prince_taldaram : public BossAI
{
    custom_boss_prince_taldaram(Creature* creature) : BossAI(creature, DATA_PRINCE_TALDARAM)
    {
...
// 60266, 60267, 60268 - Flame Sphere
struct custom_npc_prince_taldaram_flame_sphere : public ScriptedAI
{
    custom_npc_prince_taldaram_flame_sphere(Creature* creature) : ScriptedAI(creature)
    {
    }
...
// 300012, 300013 - Ancient Nerubian Device
struct custom_go_prince_taldaram_sphere : public GameObjectAI
{
    custom_go_prince_taldaram_sphere(GameObject* go) : GameObjectAI(go), instance(go->GetInstanceScript()) { }
    ...
    bool OnGossipHello(Player* /*player*/) override
    {
        ...
        if (princeTaldaram && princeTaldaram->IsAlive())
        {
            ...
            ENSURE_AI(custom_boss_prince_taldaram, princeTaldaram->AI())->CheckSpheres();
        }
        return true;
    }
};

// 102020 - Conjure Flame Sphere
class custom_spell_prince_taldaram_conjure_flame_sphere : public SpellScript
{
    PrepareSpellScript(custom_spell_prince_taldaram_conjure_flame_sphere);
    ...
    {
        OnEffectHitTarget += SpellEffectFn(custom_spell_prince_taldaram_conjure_flame_sphere::HandleScript, EFFECT_0, SPELL_EFFECT_DUMMY);
    }
};

// 102021, 102022, 102023 - Flame Sphere Summon
class custom_spell_prince_taldaram_flame_sphere_summon : public SpellScript
{
    PrepareSpellScript(custom_spell_prince_taldaram_flame_sphere_summon);
    ...
    void Register() override
    {
        OnDestinationTargetSelect += SpellDestinationTargetSelectFn(custom_spell_prince_taldaram_flame_sphere_summon::SetDest, EFFECT_0, TARGET_DEST_CASTER);
    }
};

void AddSC_custom_boss_taldaram()
{
    RegisterCustomAhnKahetCreatureAI(custom_boss_prince_taldaram);
    RegisterCustomAhnKahetCreatureAI(custom_npc_prince_taldaram_flame_sphere);
    RegisterCustomAhnKahetGameObjectAI(custom_go_prince_taldaram_sphere);
    RegisterSpellScript(custom_spell_prince_taldaram_conjure_flame_sphere);
    RegisterSpellScript(custom_spell_prince_taldaram_flame_sphere_summon);
}
