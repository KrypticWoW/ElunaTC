...
enum NadoxSpells
{
    ...
    SPELL_SUMMON_SWARMERS = 102037, // 2x 60259  -- 2x every 10secs
    SPELL_SUMMON_SWARM_GUARD = 102038, // 1x 60258
...
struct custom_boss_elder_nadox : public BossAI
{
    custom_boss_elder_nadox(Creature* creature) : BossAI(creature, DATA_ELDER_NADOX)
    {
        Initialize();
    }
...
struct custom_npc_ahnkahar_nerubian : public ScriptedAI
{
    custom_npc_ahnkahar_nerubian(Creature* creature) : ScriptedAI(creature) { }
...
// 102010 - Swarm
class custom_spell_ahn_kahet_swarm : public SpellScript
{
    PrepareSpellScript(custom_spell_ahn_kahet_swarm);
    ...
    {
        OnObjectAreaTargetSelect += SpellObjectAreaTargetSelectFn(custom_spell_ahn_kahet_swarm::CountTargets, EFFECT_0, TARGET_UNIT_SRC_AREA_ALLY);
        OnEffectHit += SpellEffectFn(custom_spell_ahn_kahet_swarm::HandleDummy, EFFECT_0, SPELL_EFFECT_DUMMY);
    }
...
{
    RegisterCustomAhnKahetCreatureAI(custom_boss_elder_nadox);
    RegisterCustomAhnKahetCreatureAI(custom_npc_ahnkahar_nerubian);
    RegisterSpellScript(custom_spell_ahn_kahet_swarm);
}
