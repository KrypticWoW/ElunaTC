...
struct custom_boss_amanitar : public BossAI
{
    custom_boss_amanitar(Creature* creature) : BossAI(creature, DATA_AMANITAR) { }
...
struct custom_npc_amanitar_mushrooms : public ScriptedAI
{
    custom_npc_amanitar_mushrooms(Creature* creature) : ScriptedAI(creature), _active(false) { }
...
// 102009 - Potent Fungus
class custom_spell_amanitar_potent_fungus : public AuraScript
{
    PrepareAuraScript(custom_spell_amanitar_potent_fungus);
    ...
    {
        AfterEffectApply += AuraEffectApplyFn(custom_spell_amanitar_potent_fungus::OnApply, EFFECT_0, SPELL_AURA_MOD_SCALE, AURA_EFFECT_HANDLE_REAL);
    }
};

void AddSC_custom_boss_amanitar()
{
    RegisterCustomAhnKahetCreatureAI(custom_boss_amanitar);
    RegisterCustomAhnKahetCreatureAI(custom_npc_amanitar_mushrooms);
    RegisterSpellScript(custom_spell_amanitar_potent_fungus);
}
