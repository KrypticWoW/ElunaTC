...
enum VolazjSpells
{
    ...
    SPELL_WHISPER_AGGRO     = 102011,
    SPELL_WHISPER_INSANITY  = 102012,
    SPELL_WHISPER_SLAY_1    = 102013,
    SPELL_WHISPER_SLAY_2    = 102014,
    SPELL_WHISPER_SLAY_3    = 102015,
    SPELL_WHISPER_DEATH_1   = 102016,
    SPELL_WHISPER_DEATH_2   = 102017,
...
struct custom_boss_volazj : public BossAI
{
    custom_boss_volazj(Creature* creature) : BossAI(creature, DATA_HERALD_VOLAZJ)
    {
        Initialize();
    }
...
struct custom_npc_twisted_visage : public ScriptedAI
{
    custom_npc_twisted_visage(Creature* creature) : ScriptedAI(creature), _playerClass(CLASS_NONE), _playerSpec(0) { }
...
/* 102011 - Volazj Whisper: Aggro
   102012 - Volazj Whisper: Insanity
   102013 - Volazj Whisper: Slay 01
   102014 - Volazj Whisper: Slay 02
   102015 - Volazj Whisper: Slay 03
   102016 - Volazj Whisper: Death 01
   102017 - Volazj Whisper: Death 02 */
class custom_spell_volazj_whisper : public SpellScript
{
    PrepareSpellScript(custom_spell_volazj_whisper);
    ...
    {
        OnEffectHitTarget += SpellEffectFn(custom_spell_volazj_whisper::HandleScriptEffect, EFFECT_0, SPELL_EFFECT_SCRIPT_EFFECT);
    }
};

void AddSC_custom_boss_volazj()
{
    RegisterCustomAhnKahetCreatureAI(custom_boss_volazj);
    RegisterCustomAhnKahetCreatureAI(custom_npc_twisted_visage);
    RegisterSpellScript(custom_spell_volazj_whisper);
}
