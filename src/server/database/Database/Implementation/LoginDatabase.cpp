...
void LoginDatabaseConnection::DoPrepareStatements()
{
    ...
    PrepareStatement(LOGIN_SEL_CUSTOM_ACCOUNT, "SELECT AccountID, ArtifactLevel, ArtifactExperience, AnnounceExp, Buffs, AllowTextDetails FROM custom.account_info WHERE AccountID = ?", CONNECTION_SYNCH);
