...
enum LoginDatabaseStatements : uint32
{
    ...
    */
    ...
    // Custom Sql Queries
    LOGIN_SEL_CUSTOM_ACCOUNT,
    LOGIN_INS_CUSTOM_ACCOUNT,
    LOGIN_UPD_CUSTOM_ACCOUNT,

    LOGIN_SEL_CUSTOM_CHARACTER,
    LOGIN_INS_CUSTOM_CHARACTER,
    LOGIN_UPD_CUSTOM_CHARACTER,
    LOGIN_DEL_CUSTOM_CHARACTER,
    LOGIN_DEL_CUSTOM_WEAPON,
